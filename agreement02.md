# 車座Fab集会！vol.2 《ファブ施設運営のネガポジ編》 参加同意書
------
...
5. 【クレジット】主催者等は、成果物を公開・利用する場合、同意書にて表明するクレジット表記の確認（本書末尾記載）に従い、クレジット表記を要する者に対してはクレジットを表記します。クレジット表記を不要とする者に対しては、クレジットを表記しません。ただし、本イベントにおいて参加者がMiroで作成した文章、スケッチ、図についてはクレジット表記の確認の内容を問わずクレジットを表記しません。
